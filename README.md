...
- ChatGPT技术原理解析：从RL之PPO算法、RLHF到GPT4、instructGPT (@corleytd 、@zh2nlp 已同步)
- Transformer通俗笔记：从Word2Vec、Seq2Seq逐步理解到GPT、BERT (@wangzaistone @已同步)
- RL所需的微积分/概率统计基础、最优化基础
- 强化学习极简入门：通俗理解MDP、DP MC TC和Q学习、策略梯度、PPO (@hyq-401、@EthanStewart2023 已同步)
